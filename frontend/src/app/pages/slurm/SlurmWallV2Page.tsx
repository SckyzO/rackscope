  ...
  return (
    <div className="relative flex items-stretch rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
      <button
        onClick={onRefresh}
        disabled={refreshing}
        className="flex items-center gap-1.5 rounded-l-lg px-3 py-2 text-sm text-gray-600 transition-colors hover:bg-gray-50 disabled:opacity-50 dark:text-gray-300 dark:hover:bg-gray-700"
      >
      ...
      <div className="relative">
        <button
          onClick={() => setOpen((v) => !v)}
          className="flex h-full items-center rounded-r-lg px-2 text-gray-400 hover:bg-gray-50 dark:text-gray-500 dark:hover:bg-gray-700"
        >

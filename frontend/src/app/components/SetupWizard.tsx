          ...
          {step === 1 && (
            <div className="p-8">
              ...
              <p className="mt-2 text-center text-sm text-gray-500 dark:text-gray-400">
                Prometheus-first physical infrastructure monitoring. Let's get you set up in 2
                steps.
              </p>
          ...
          {step === 3 && (
            <div className="p-8 text-center">
              ...
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Rackscope is ready. Next: describe your physical infrastructure (sites, rooms,
                racks) using the topology editor.
              </p>

...
const ROUTE_LABELS: Record<string, string> = {
  ...
  '/ui-library/buttons-group': 'Buttons Group',
  '/ui-library/badges': 'Badges',
  '/ui-library/alerts': 'Alerts',
  '/ui-library/cards': 'Cards',
  '/ui-library/carousel': 'Carousel',
  '/ui-library/dropdowns': 'Dropdowns',
  '/ui-library/links': 'Links',
  '/ui-library/list': 'List',
  '/ui-library/modals': 'Modals',
  '/ui-library/notifications': 'Notifications',
  '/ui-library/pagination': 'Pagination',
  '/ui-library/popovers': 'Popovers',
  '/ui-library/progress-bar': 'Progress Bar',
  '/ui-library/ribbons': 'Ribbons',
  '/ui-library/spinners': 'Spinners',
  '/ui-library/tabs': 'Tabs',
  '/ui-library/tooltips': 'Tooltips',
  '/ui-library/breadcrumb': 'Breadcrumb',
  '/ui-library/form-elements': 'Form Elements',
  '/ui-library/avatars': 'Avatars',
  '/charts': 'Charts',
  '/tables': 'Data Tables',
  '/profile': 'Profile',
  '/calendar': 'Calendar',

...
const RackCard = ({
  ...
  return (
    <div
      ...
      style={cardStyle}
      onClick={!editMode ? () => { window.location.href = `/cosmos/views/rack/${rack.id}`; } : undefined}
      role={!editMode ? 'button' : undefined}
      tabIndex={!editMode ? 0 : undefined}
      onKeyDown={!editMode ? (e) => { if (e.key === 'Enter' || e.key === ' ') window.location.href = `/cosmos/views/rack/${rack.id}`; } : undefined}
    >
...
export const CosmosClusterPage = () => {

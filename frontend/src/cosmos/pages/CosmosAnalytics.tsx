...
const StatCard = ({ title, value, change, positive, icon, iconBg, iconColor }: StatCardProps) => (
  <div className="shadow-theme-sm rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
...
const TopPagesRow = ({ page, views, bar }: { page: string; views: string; bar: number }) => (
  <div className="flex items-center justify-between gap-4 border-b border-gray-100 py-3 last:border-0 dark:border-gray-800">
    <span className="truncate text-sm text-gray-600 dark:text-gray-400">{page}</span>
    <div className="flex shrink-0 items-center gap-3">
      <div className="h-1.5 w-24 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
        <div className="bg-brand-500 h-full rounded-full" style={{ width: `${bar}%` }} />
      </div>
...
export const CosmosAnalytics = () => (
  <div className="space-y-6">
    ...
    {/* Main chart area */}
    <div className="shadow-theme-sm rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">

    ...
    pages: [
      {
        ...
        iconName: 'Activity',
        route: '/cosmos/slurm/overview',
      },
      {
        id: 'slurm-wallboard-{id}',
        title: 'Wallboard: {name}',
        iconName: 'MapPin',
        route: '/cosmos/slurm/wallboard/{id}',
        dynamic: 'rooms',
        requiresPlugin: 'slurm',
      },
      {
        ...
        title: 'Slurm Nodes',
        iconName: 'List',
        route: '/cosmos/slurm/nodes',
      },
      {
        id: 'slurm-alerts',
        title: 'Slurm Alerts',
        iconName: 'AlertTriangle',
        route: '/cosmos/slurm/alerts',
      },
    ],
  },
  {

...
// ── CosmosSearch component ────────────────────────────────────────────────────

export const CosmosSearch = () => {
        ...
        <div className="absolute top-full left-0 z-50 mt-1.5 w-full min-w-[360px] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900">
          <div className="px-4 py-3">
            ...
            <div className="grid grid-cols-2 gap-1">
              {[
                { icon: Globe, label: 'World Map', href: '/cosmos/views/worldmap' },
                { icon: Bell, label: 'Notifications', href: '/cosmos/notifications' },
                { icon: Activity, label: 'Slurm Overview', href: '/cosmos/slurm/overview' },
                { icon: AlertTriangle, label: 'Slurm Alerts', href: '/cosmos/slurm/alerts' },
                { icon: Settings, label: 'Settings', href: '/cosmos/settings' },
                { icon: BarChart2, label: 'Health Status', href: '/cosmos/rackscope/health' },
